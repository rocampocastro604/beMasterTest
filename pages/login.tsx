...
function Login() {
  ...
  return (
    <div className="relative flex h-screen w-screen flex-col md:items-center md:justify-center">
      ...
      <form className="relative mt-24 space-y-8 rounded py-10 px-6 md:mt-0 md:max-w-md md:px-14" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="text-[gray]">
          ...
          <button
            ...
            type="submit" onClick={() => setLogin(false)}
          >
            Sign up now
          </button>
        </div>
